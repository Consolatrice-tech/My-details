...
<html lang="en" class="no-js">
  <head>
    ...
    <title>Consolatrice BYIRINGIRO - Resume / CV </title>
                        ...
                        <div class="portfolio-grid three-columns">
                          ...
                          <figure class="item lbaudio" data-groups='["category_all", "category_soundcloud"]'>
                            <div class="portfolio-item-img">
                              <img src="{{ asset('frontend/img/dotpharma.png') }}" alt="DotPharma" title="" />
                              <a href="https://www.dotpharma.rw/" class="lightbox mfp-iframe" title="Money Watch Project"></a>
                            </div>

                            <i class="fa fa-volume-up"></i>
                            <h4 class="name">DOTPharma</h4>
                            <span class="category"></span>
                          </figure>

                          <figure class="item lbaudio" data-groups='["category_all", "category_soundcloud"]'>
                            <div class="portfolio-item-img">
                              <img src="{{ asset('frontend/img/porfolio.png') }}" alt="DotPharma" title="" />
                              <a href="https://dev-consolatriceportfolio.pantheonsite.io/" class="lightbox mfp-iframe" title="Money Watch Project"></a>
                            </div>

                            <i class="fa fa-volume-up"></i>
                            <h4 class="name">Portfolio</h4>
                            <span class="category"></span>
                          </figure>

                          <figure class="item lbaudio" data-groups='["category_all", "category_soundcloud"]'>
                            <div class="portfolio-item-img">
                              <img src="{{ asset('frontend/img/forexbureau.png') }}" alt="DotPharma" title="" />
                              <a href="https://forex-bureau-50458.herokuapp.com/" class="lightbox mfp-iframe" title="Money Watch Project"></a>
                            </div>

                            <i class="fa fa-volume-up"></i>
                            <h4 class="name">Forexbureau.com</h4>
                            <span class="category"></span>
                          </figure>

                          <figure class="item lbaudio" data-groups='["category_all", "category_soundcloud"]'>
                            <div class="portfolio-item-img">
                              <img src="{{ asset('frontend/img/Laravel-Blog.png') }}" alt="DotPharma" title="" />
                              <a href="https://github.com/Consolatrice-tech/Laravel-Blog-Front-end-Backend-.git" class="lightbox mfp-iframe" title="Money Watch Project"></a>
                            </div>

                            <i class="fa fa-volume-up"></i>
                            <h4 class="name">Blog - Laravel</h4>
                            <span class="category"></span>
                          </figure>

                          <figure class="item lbaudio" data-groups='["category_all", "category_soundcloud"]'>
                            <div class="portfolio-item-img">
                              <img src="{{ asset('frontend/img/moneyWatch.png') }}" alt="DotPharma" title="" />
                          ...
                          <figure class="item lbaudio" data-groups='["category_all", "category_soundcloud"]'>
                            <div class="portfolio-item-img">
                              <img src="{{ asset('frontend/img/portfolio-ReactJs.png') }}" alt="DotPharma" title="" />
                              <a href="https://consolatrice-byiringiro.netlify.app/" class="lightbox mfp-iframe" title="Money Watch Project"></a>
                            </div>
